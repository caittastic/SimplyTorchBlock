...
import static caittastic.torchblocktastic.TorchBlocktastic.TORCH_BLOCK_MAP;

public class ModTorchBlock extends Block {
    public ModTorchBlock(Properties p_49795_) {
        super(p_49795_);
    }
    ...
    public @NotNull InteractionResult use(BlockState blockState, Level level, BlockPos bPos, Player player, InteractionHand iHand, BlockHitResult bHitResult) {
        ...
        BlockState whiteTorchBlockBlockState = TORCH_BLOCK_MAP.get("white").get().defaultBlockState(); //the default block state of the white torch block
